...
\centering
	...
	(d) Composition dependence of O-O bond distances determined from PDF data (second peaks in Figure \ref{fig:label:waterfall}). 
	}
	\label{fig:exafs_all}
\end{figure*}  
